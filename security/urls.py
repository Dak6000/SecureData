...
from .views import (
    ...
    update_rule_params, resolve_all_alerts, export_filtered_results
)
from .api_views import dashboard_stats_api, user_statistics_api, live_events_api
...
urlpatterns = [
    ...
    path('alerts/resolve-all/', resolve_all_alerts, name='resolve_all_alerts'),
    ...
    path('export-filtered/', export_filtered_results, name='export_filtered_results'),
    ...
    path('api/live-events/', live_events_api, name='api_live_events'),
]